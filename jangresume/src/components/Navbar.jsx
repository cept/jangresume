...
const Navbar = () => {
  return (
    <nav className='flex justify-between items-center px-4 lg:px-24 xl:px-40 py-4 sticky top-0 z-99 backdrop-blur-xl font-medium bg-white/50'>
      ...
      <div className='flex gap-5'>
        ...
        <a href="" className='hover:text-primary transition-all'>Dashboard</a>
        <a href="" className='hover:text-primary transition-all'>Templates</a>
      </div>
